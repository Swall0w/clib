...
def out_gen_image(generator, H, W, rows, cols, dst):
    ...
    def make_image(trainer):
        ...
        preview_path = preview_dir + '/image{:0>5}.png'.format(
...
def main():
    ...
    updater = WGANUpdater(train_iter, generator, critic,
                          5, op_g, op_c, device=args.gpu)
    ...
    trainer.extend(out_gen_image(generator, 28, 28, 5, 5, args.output),
                   trigger=(1, 'epoch'))
