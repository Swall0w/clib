...
def arg():
    ...
    parser.add_argument('--box','-b',type=int,default=5,help='number of boxes')
    parser.add_argument('--layer','-l',type=int,default=18,help='number of partial layer')
    parser.add_argument('--input','-i',type=str,default='result/darknet19_448.weights',help='number of partial layer')
    parser.add_argument('--output','-o',type=str,default='result/darknet19_448.conv.23',help='number of partial layer')
