...
def arg():
    ...
    parser.add_argument('--model','-m',default='darknet19_448.conv.23',help='Initial model')
    ...
    parser.add_argument('--cls','-c',type=int,default=20,help='number of classes')
    parser.add_argument('--box',type=int,default=5,help='number of boxes')
    parser.add_argument('--images',default='JPEGImages/',help='Directory name that contains images')
    parser.add_argument('--labels',default='labels/', help='Directory name that contains labels')
    parser.add_argument('--tags',default='voc.names', help='label list')
...
def main():
    ...
    train = PreprocessedDataset(dirs=(args.images,args.labels),resize=resize,tags=args.tags)
    train_itr = YoloIterator(dataset=train,batch_size=args.batch)
    ...
    trainer.extend(extensions.PrintReport(['epoch','elapsed_time','iteration','main/loss','lr','main/x_loss','main/y_loss','main/w_loss','main/h_loss','main/c_loss','main/p_loss']))
